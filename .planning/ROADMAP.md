...
- [x] 08-02-PLAN.md — Lawyer customization UI: template selector, split-view editor with @dnd-kit drag & drop, branding editor, live preview
...
- [x] 09-03-PLAN.md — Hosted lawyer pages (/cabinet-[slug]) with landing hero + specialties + intake form, OG images, integration settings page with snippet copy
